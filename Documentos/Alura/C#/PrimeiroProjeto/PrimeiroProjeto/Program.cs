...
//List<string> listaDasBandas = new List<string>() { "Scalene", "Terno rei", "Skank"};

Dictionary<string, List<int>> bandasRegistradas = new Dictionary<string, List<int>>();
bandasRegistradas.Add("Linkin Park", new List<int> {10, 8, 9});
bandasRegistradas.Add("O Grilo", new List<int>());
...
void mostrarBandasRegistradas() 
{
    ...
    {
        Console.WriteLine($"Banda: {banda}"); Console.WriteLine();
    }
...
{
    int quantidadDeLetras = titulo.Length;
    string asteristo = string.Empty.PadLeft(quantidadDeLetras, '*');
    Console.WriteLine(asteristo);
